...
=======
{: .func4}
>>>>>>> cd9b94583b (docs: Standardize documentation headings (remove multiple # H1)):doc/architecture/SW_archi.md
>>>>>>> d88b40900b (docs: Standardize documentation headings (remove multiple # H1))
