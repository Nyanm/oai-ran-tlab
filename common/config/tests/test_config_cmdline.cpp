...
TEST(cmdline, load_file_and_cmdline)
{
  ...
  if (access(conf_path, F_OK) != 0) {
    conf_path = "common/config/tests/test_config.conf";
  }
  if (access(conf_path, F_OK) != 0) {
    conf_path = "build/common/config/tests/test_config.conf";
  }
