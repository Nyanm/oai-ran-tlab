...
#define CONFIG_HLP_EMULATE_L1    "Enable emulated L1 mode for L2 proxy operation\n"
...
#define CMDLINE_PARAMS_DESC {  \
  ...
  {"emulate-l1",            CONFIG_HLP_EMULATE_L1,    PARAMFLAG_BOOL, .iptr=&EMULATE_L1,                       .defintval=0,            TYPE_INT,    0}, \
