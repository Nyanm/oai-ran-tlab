...
void dft64(int32_t *x,int32_t *y,int scale);
void dft128(int32_t *x,int32_t *y,int scale);
void dft256(int32_t *x,int32_t *y,int scale);
void dft512(int32_t *x,int32_t *y,int scale);
void dft1024(int32_t *x,int32_t *y,int scale);
void dft2048(int32_t *x,int32_t *y,int scale);
void dft4096(int16_t *x,int16_t *y,int scale);
void dft8192(int16_t *x,int16_t *y,int scale);
void idft64(int32_t *x,int32_t *y,int scale);
void idft128(int32_t *x,int32_t *y,int scale);
void idft256(int32_t *x,int32_t *y,int scale);
void idft512(int32_t *x,int32_t *y,int scale);
void idft1024(int32_t *x,int32_t *y,int scale);
void idft2048(int32_t *x,int32_t *y,int scale);
