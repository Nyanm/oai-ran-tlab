					     ...
					     int8_t sidx)
{
  ...
  if ((E1&3) == 0 && (E2&3) == 0) {
    ...
    gpuLaunchKernel(rm2,nblocks2, nthreads, 0, s[sidx],Ncb/2,ind/2,E1,E2,r_firstE2,Foffset/2,F/2,clear,68*384/2,K/2,Z/2,(uint32_t*)d,(uint32_t*)soft_input,(uint16_t*)llr_buffer);
  }
