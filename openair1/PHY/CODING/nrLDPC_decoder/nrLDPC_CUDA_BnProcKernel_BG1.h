...
__device__ __forceinline__ void bnProcKernel_BG1_int8_Gn_R13(const int8_t *__restrict__ d_bnProcBuf,
...
__device__ __forceinline__ void bnProcKernel_BG1_int8_Gn_R23(const int8_t *__restrict__ d_bnProcBuf,
                                                             int8_t *__restrict__ d_cnProcBuf,
                                                             const int8_t *__restrict__ d_llrProcBuf,
                                                             int8_t *__restrict__ d_llrRes,
                                                             uint32_t lane,
