                                                         ...
                                                         uint32_t Zc)
{
  ...
  ////const uint32_t row = MsgIdx - 1; // row = 0,1,2  -> 3 BNs
                                                         ...
                                                         uint32_t Zc)
{
  ...
  // const uint16_t *lut_circShift_CNG = arrPos(p_lut->circShift[groupIdx], row);
  //  uint32_t *lut_startAddrBnProcBuf_CNG = arrPos(p_lut->startAddrBnProcBuf[groupIdx], row);
  // const uint8_t *lut_bnPosBnProcBuf_CNG = arrPos(p_lut->bnPosBnProcBuf[groupIdx], row);
                                                          ...
                                                          uint32_t Zc)
{
  ...
  // const uint32_t row = MsgIdx - 1; // row = 0,1,...,18
