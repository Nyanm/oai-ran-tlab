                     ...
                     c16_t *chFext_slot)
{
  ...
  // Pointer arrays into mag VLA rows (required by nr_channel_compensation / nr_mmse_2layers)
  c16_t *p_maga[nb_layer], *p_magb[nb_layer], *p_magc[nb_layer];
  for (int l = 0; l < nb_layer; l++) {
    p_maga[l] = rxF_ch_maga[l];
    p_magb[l] = rxF_ch_magb[l];
    p_magc[l] = rxF_ch_magc[l];
  }
