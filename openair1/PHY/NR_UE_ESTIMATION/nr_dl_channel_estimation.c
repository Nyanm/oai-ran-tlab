                              ...
                              NR_UE_DLSCH_t dlsch[2])
{
  ...
  for (int aarx=0; aarx<frame_parms->nb_antennas_rx; aarx++) {
    ...
    if(symbol == (symbInSlot -1)) {
      ...
      LOG_M("rxdataF_bf_ptrs_comp.m", "bf_ptrs_cmp", rxdataF_comp[aarx] + (*startSymbIndex) * rx_size_symbol, rx_size_symbol * (*nbSymb), 1, 1);
#endif
      /*------------------------------------------------------------------------------------------------------- */
...
#endif
          rotate_cpx_vector(rxdataF_comp[i][aarx],
                            &phase_per_symbol[i],
                            rxdataF_comp[i][aarx],
