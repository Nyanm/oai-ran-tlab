                                 ...
                                 ho_failure_t failure)
{
  ...
  *hpi = copy_byte_array(*ho_prep_info);
  ...
  f1ap_ue_context_setup_req_t ue_context_setup_req = rrc_fill_f1_ue_context_setup(rrc, ue, target_du, NULL);
  ue_context_setup_req.cu_to_du_rrc_info.ho_prep_info = hpi;
