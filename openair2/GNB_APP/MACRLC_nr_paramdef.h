...
#define CONFIG_STRING_MACRLC_BEAM_POL_OFFSET               "beam_id_polarization_offset"
...
#define CONFIG_STRING_MACRLC_SPATIAL_STREAM_IDX            "spatial_stream_index"
...
#define MACRLCPARAMS_DESC { \
  ...
  {CONFIG_STRING_MACRLC_BEAM_POL_OFFSET,             HLP_MACRLC_BEAM_POL_OFFSET, 0, .u8ptr=NULL, .defintval=0,              TYPE_UINT8,   0}, \
  ...
  {CONFIG_STRING_MACRLC_SPATIAL_STREAM_IDX,          HLP_MACRLC_SPATIAL_STREAM_INDEX, \
