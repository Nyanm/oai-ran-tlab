 ...
 * @{*/
extern char filename[FILENAME_LENGTH_MAX]; /*!< \brief user_name.file_date.xml */
extern char user_name[FILENAME_LENGTH_MAX / 2]; /*!< \brief user_name  */
extern char file_date[FILENAME_LENGTH_MAX / 2]; /*!< \brief file_date */
extern char src_file[FILENAME_LENGTH_MAX + DIR_LENGTH_MAX]; /*!< \brief USER_XML_FOLDER/user_name.file_date.xml or DEMO_XML_FOLDER/user_name.file_date.xml */
extern char dst_dir[DIR_LENGTH_MAX]; /*!< \brief user_name/file_date/ */
