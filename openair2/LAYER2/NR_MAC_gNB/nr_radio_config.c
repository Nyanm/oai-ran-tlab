                                                   ...
                                                   int ssb_index)
{
  ...
  int first_active_bwp = configuration->first_active_bwp;
  ...
  if (first_active_bwp == 0) {
    ...
    NR_BWP_Uplink_t *ubwp = config_uplinkBWP(first_active_bwp, true, uid, maxMIMO_Layers, configuration, scc, NULL);
                                                            ...
                                                            int ssb_index)
{
  ...
  *uplinkConfig->firstActiveUplinkBWP_Id = new_bwp != 0;  // 1 for any BWP != 0
  ...
  if (new_bwp == 0) {
    ...
    NR_BWP_Uplink_t *ul_bwp = config_uplinkBWP(new_bwp, true, uid, ul_maxMIMO_Layers, &local_config, scc, uecap);
